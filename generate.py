...
def parse_args():
    parser = argparse.ArgumentParser(description="Configure resume feedback script parameters")

    parser.add_argument("--path", type=str, help="Path to resume in PDF form")
    args = parser.parse_args()
    return args

if __name__ == "__main__":
    args = parse_args()
    predict(resume=args.path)